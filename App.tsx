        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8 scrollbar-thin">
          ...
          {selectedElement && selectedItemData && (
            <section className="bg-slate-900 p-5 rounded-2xl space-y-4 animate-in">
              ...
              {selectedElement.id === 'member_photo' ? (
                <div className="space-y-4">
                  <div className="space-y-1"><div className="flex justify-between text-[8px] font-black text-slate-500 uppercase"><span>X Position</span><span className="text-white">{(selectedItemData as PhotoItem).x}px</span></div><input type="range" min="0" max="1000" value={(selectedItemData as PhotoItem).x} onChange={e => updateItem(selectedElement.sideIdx, 'member_photo', {x: +e.target.value})} className="w-full accent-red-600" /></div>
                  <div className="space-y-1"><div className="flex justify-between text-[8px] font-black text-slate-500 uppercase"><span>Y Position</span><span className="text-white">{(selectedItemData as PhotoItem).y}px</span></div><input type="range" min="0" max="1000" value={(selectedItemData as PhotoItem).y} onChange={e => updateItem(selectedElement.sideIdx, 'member_photo', {y: +e.target.value})} className="w-full accent-red-600" /></div>
                  <div className="space-y-1"><div className="flex justify-between text-[8px] font-black text-slate-500 uppercase"><span>Width</span><span className="text-white">{(selectedItemData as PhotoItem).width}px</span></div><input type="range" min="50" max="600" value={(selectedItemData as PhotoItem).width} onChange={e => updateItem(selectedElement.sideIdx, 'member_photo', {width: +e.target.value})} className="w-full accent-red-600" /></div>
                  <div className="space-y-1"><div className="flex justify-between text-[8px] font-black text-slate-500 uppercase"><span>Height</span><span className="text-white">{(selectedItemData as PhotoItem).height}px</span></div><input type="range" min="50" max="600" value={(selectedItemData as PhotoItem).height} onChange={e => updateItem(selectedElement.sideIdx, 'member_photo', {height: +e.target.value})} className="w-full accent-red-600" /></div>
                  <div className="space-y-1"><div className="flex justify-between text-[8px] font-black text-slate-500 uppercase"><span>Border Radius</span><span className="text-white">{(selectedItemData as PhotoItem).borderRadius}px</span></div><input type="range" min="0" max="100" value={(selectedItemData as PhotoItem).borderRadius} onChange={e => updateItem(selectedElement.sideIdx, 'member_photo', {borderRadius: +e.target.value})} className="w-full accent-red-600" /></div>
