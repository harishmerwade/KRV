...
const TEMPLATE_URLS = {
  ...
  id_front: 'https://raw.githubusercontent.com/harishmerwade/KRV/709c8c68706c31a15dd4b87607082457cc7950d0/Img/1.png',
...
const INITIAL_LAYOUT_CERT2: FullLayout = {
  sides: [{
    ...
    textItems: [
      { id: "pledge_text_1", text: "ಹೆಚ್. ಶಿವರಾಮೇಗೌಡರ ಕರ್ನಾಟಕ ರಕ್ಷಣಾ ವೇದಿಕೆಯ ರಾಜ್ಯಾಧ್ಯಕ್ಷರ ನೇತೃತ್ವದಲ್ಲಿ ಸತ್ಯನ್ಯಾಯ-ಧರ್ಮವನ್ನು ಪಾಲಿಸಿಕೊಂಡು, ಆತ್ಮಪೂರ್ವಕವಾಗಿ ಈ ಕೆಳಕಂಡ ಪ್ರತಿಜ್ಞಾವಿಧಿಯ ಪ್ರಮಾಣವಚನ ಸ್ವೀಕರಿಸುತ್ತಿದ್ದೇವೆ.", x: 19.9, y: 506.99, fontSize: 20, color: "#000000", isBold: true, isLocked: false, width: 965, lineHeight: 1.6, isVisible: true },
      { id: "pledge_text_2", text: "ಕನ್ನಡ ನಾಡು, ನುಡಿ, ನೆಲ, ಜಲ, ಗಡಿ, ಭಾಷೆ ಸಂಸ್ಕೃತಿಯನ್ನು ಉಳಿಸಿ ಬೆಳೆಸುವ ಮಹತ್ತರ ಕಾರ್ಯದಲ್ಲಿ ನಾವಲ್ಲರೂ ಕನ್ನಡಾಂಬೆಯ ಸುಪುತ್ರ / ಸುಪುತ್ರಿಯರಾಗಿ ಒಮ್ಮತದಿಂದ ಶ್ರಮಿಸುತ್ತೇವೆ ಎಂದು ಈ ಮೂಲಕ ಪ್ರತಿಜ್ಞೆ ಮಾಡಿ ಕೆಳಗೆ ಸಹಿ ಹಾಕಿರುತ್ತೇನೆ.", x: 48.54, y: 574.4, fontSize: 20, color: "#000000", isBold: true, isLocked: false, width: 907, lineHeight: 1.6, isVisible: true },
