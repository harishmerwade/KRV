...
const FALLBACK_TEMPLATE = 'data:image/svg+xml;charset=UTF-8,%3Csvg width="1000" height="1414" xmlns="http://www.w3.org/2000/svg"%3E%3Crect width="1000" height="1414" fill="%23ffffff"/%3E%3Cpath d="M50 50h900v1314H50z" fill="none" stroke="%23e2e8f0" stroke-width="2" stroke-dasharray="10 10"/%3E%3Ctext x="500" y="707" font-family="sans-serif" font-size="24" fill="%23cbd5e1" text-anchor="middle"%3EPlease Upload Template Background%3C/text%3E%3C/svg%3E';

const INITIAL_TEXT_ITEMS: TextItem[] = [
  {
    id: 'pledge_text_1',
    text: "ಹೆಚ್. ಶಿವರಾಮೇಗೌಡರ ಕರ್ನಾಟಕ ರಕ್ಷಣಾ ವೇದಿಕೆಯ ರಾಜ್ಯಾಧ್ಯಕ್ಷರ ನೇತೃತ್ವದಲ್ಲಿ ಸತ್ಯ-ನ್ಯಾಯ-ಧರ್ಮವನ್ನು ಪಾಲಿಸಿಕೊಂಡು, ಧರ್ಮಸ್ಥಳದ ಶ್ರೀ ಮಂಜುನಾಥಸ್ವಾಮಿ ಮೇಲೆ ಆತ್ಮಪೂರ್ವಕವಾಗಿ ಈ ಕೆಳಕಂಡ ಪ್ರತಿಜ್ಞಾವಿಧಿಯ ಪ್ರಮಾಣವಚನ ಸ್ವೀಕರಿಸುತ್ತಿದ್ದೇವೆ.",
    x: 258.2835820895522,
    y: 524.6746268656716,
    fontSize: 18,
    color: "#000000",
  ...
  {
    id: 'pledge_text_2',
    text: "ಕನ್ನಡ ನಾಡು, ನುಡಿ, ನೆಲ, ಜಲ, ಗಡಿ, ಭಾಷೆ ಸಂಸ್ಕೃತಿಯನ್ನು ಉಳಿಸಿ ಬೆಳೆಸುವ ಮಹತ್ತರ ಕಾರ್ಯದಲ್ಲಿ ನಾವೆಲ್ಲರೂ ಕನ್ನಡಾಂಬೆಯ ಸುಪುತ್ರ / ಸುಪುತ್ರಿಯರಾಗಿ ಒಮ್ಮತದಿಂದ ಶ್ರಮಿಸುತ್ತೇವೆ ಎಂದು ಈ ಮೂಲಕ ಪ್ರತಿಜ್ಞೆ ಮಾಡಿ ಕೆಳಗೆ ಸಹಿ ಹಾಕಿರುತ್ತೇನೆ.",
    x: 118.9940298507463,
    y: 640,
    fontSize: 18,
    color: "#000000",
        ...
        >
          <div 
            ...
            style={{ 
              ...
              backgroundImage: `url(${customTemplate || FALLBACK_TEMPLATE})`,
